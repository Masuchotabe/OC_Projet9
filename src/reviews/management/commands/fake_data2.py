...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--with-images', action='store_true', help='Add images to tickets (slower)')
    ...
    def get_random_image(self):
        ...
        try:
            ...
            if response.status_code == 200:
                return ContentFile(response.content, name=f'ticket_{random.randint(1000, 9999)}.jpg')
    ...
    def handle(self, *args, **options):
        ...
        if options['with_images']:
            self.stdout.write(self.style.WARNING('Images enabled - this may take a while...'))
